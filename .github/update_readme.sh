...
![alpine](https://img.shields.io/badge/alpine-edge-0D597F?style=for-the-badge&logo=alpine-linux) ![redis](https://img.shields.io/badge/redis-${APP_VERSION}-DC382D?style=for-the-badge&logo=redis)
...
To upgrade, all you have to do is pull the latest Docker image. We automatically check for Redis updates daily so there may be some delay when an update is released to when the image is updated." >README.md
